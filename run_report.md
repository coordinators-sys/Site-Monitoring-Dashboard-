...
Run 2026-08-06 05:51. Regenerated from live sources.

## Sources & scope
| | Kobo (all partners except IOM) | Zite Manager (IOM) |
|---|---|---|
| In Q2 2026 window | **469** submissions | **842** site records |
| After dedup to site grain | **467** | **838** |
...
**Union: 1305 sites.** 19 duplicate Kobo submissions collapsed
...
2. **Education carries a hard critical floor.** At a site with no learning centre,
   ...
   it is a floor effect, not a gradient. Current split: 620 of 1305 sites are
   critical on that single indicator; the remaining 685 are scored across
   all 11 and distribute normally (G=363 Y=190 R=132).
...
## Validation
- [PASS] sites.json rows (1305) == union (1305)
- [PASS] 467 Kobo + 838 IOM == 1305
- [PASS] every sector cell classified: 15660 == 1305 x 12
...
- [PASS] national severity recomputes (45.4 vs KPI 45.4)
...
- [PASS] source counts agree across provenance/recon/sites.json (467+838 vs recon 467 vs 1305)
- [PASS] age/sex summed over 426 distinct verification rows (427 site rows matched)
...
- **No validated Kobo<->Zite crosswalk.** Master-List matching by code, name and GPS *is*
  performed (839 of 1,305 sites resolved,
  methods: {'code': 281, 'none': 466, 'name': 457, 'gps+name': 107}), and it is what collapses cross-source
