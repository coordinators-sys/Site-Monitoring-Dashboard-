...
Run 2026-08-07 04:56. Regenerated from live sources.

## Sources & scope
| | Kobo (all partners except IOM) | Zite Manager (IOM) |
|---|---|---|
| In Q2 2026 window | **469** submissions | **832** site records |
| After dedup to site grain | **467** | **828** |
...
**Union: 1295 sites.** 19 duplicate Kobo submissions collapsed
...
2. **Education carries a hard critical floor.** At a site with no learning centre,
   ...
   it is a floor effect, not a gradient. Current split: 620 of 1295 sites are
   critical on that single indicator; the remaining 675 are scored across
   all 11 and distribute normally (G=353 Y=190 R=132).
...
## Validation
- [PASS] sites.json rows (1295) == union (1295)
- [PASS] 467 Kobo + 828 IOM == 1295
- [PASS] every sector cell classified: 15540 == 1295 x 12
...
- [PASS] national severity recomputes (45.6 vs KPI 45.6)
...
- [PASS] source counts agree across provenance/recon/sites.json (467+828 vs recon 467 vs 1295)
- [PASS] age/sex summed over 416 distinct verification rows (417 site rows matched)
...
- **No validated Kobo<->Zite crosswalk.** Master-List matching by code, name and GPS *is*
  performed (831 of 1,295 sites resolved,
  methods: {'code': 281, 'none': 464, 'name': 454, 'gps+name': 102}), and it is what collapses cross-source
